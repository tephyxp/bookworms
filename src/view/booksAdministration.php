                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-2">
                                <label for="title">Titulo:
                                    <input class="form-control custom-input mb-2" type="text" name="title" value="<?= ($bookDetails !== null) ? $bookDetails['title'] : '' ?>">
                                </label>
                            </div>
                            <div class="mb-2">
                                <label for="author">Autor:
                                    <input type="text" name="author" value="<?= ($bookDetails !== null) ? $bookDetails['author'] : '' ?>" class="custom-input form-control mb-2">
                                </label>
                            </div>
                            <div class="mb-2">
                                <label for="isbn">ISBN:
                                    <input type="text" name="isbn" value="<?= ($bookDetails !== null) ? $bookDetails['isbn'] : '' ?>" class="custom-input form-control mb-2"/>
                                </label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="mb-2">
                                <label for="description">Descripción:
                                    <textarea name="description" class="custom-input form-control mb-2"><?= ($bookDetails !== null) ? $bookDetails['description'] : '' ?></textarea>
                                </label>
                            </div>
                        </div>
